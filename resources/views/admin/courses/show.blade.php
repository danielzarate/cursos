    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/4491461/pexels-photo-4491461.jpeg" alt="">
                @endif
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside">
                    ...
                    @empty
                        <li class="text-gray-700 text-base">Aún no hay requisitos</li>
                    @endforelse
        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.courses.observation',$course)}}" class="btn btn-danger w-full block mt-4 text-center ">Agregar Observaciones</a>
